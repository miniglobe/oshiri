...
def train():
    ...
    train_ids_path, dev_ids_path, train_vocab_path, test_vocab_path = input_reader.prepare_data(
        FLAGS.data_dir,
        FLAGS.vocab_size,
        )
    ...
    with tf.Session() as sess:
      ...
      dev_set = read_data(dev_ids_path)
      train_set = read_data(train_ids_path, FLAGS.max_train_data_size)
